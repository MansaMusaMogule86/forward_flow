    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Youth Futures is for justice-impacted or community-referred youth in two groups: ages 14-20 and ages 21-25.'
        }
      },
      {
        '@type': 'Question',
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="AI-powered career tools and mentorship for justice-impacted youth in two groups: ages 14-20 and 21-25. 100% free participation powered by sponsors."
        path="/youth-futures"
      />
        ...
        <div className="container px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              <Badge className="bg-osu-scarlet text-white hover:bg-osu-scarlet/90 px-4 py-1">Ages 14-20 & 21-25</Badge>
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                AI-powered career tools and mentorship for justice-impacted youth in two groups: ages 14-20 and 21-25.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 divide-y md:divide-y-0 md:divide-x divide-white/20">
            <div className="space-y-6 pb-8 md:pb-0">
              ...
              <ul className="space-y-4 text-lg opacity-90">
                ...
                <li className="flex items-center gap-3"><Users className="h-5 w-5 pro-list-icon" /> Age Group 2: 21-25</li>
