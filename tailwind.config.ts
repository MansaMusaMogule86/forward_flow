	...
	theme: {
		...
		extend: {
			...
			fontFamily: {
				...
				heading: ['Cormorant Garamond', 'Outfit', 'Georgia', 'serif'],
			...
			animation: {
				...
				'cipher-fade-up':  'cipher-fade-up 0.9s cubic-bezier(0.16,1,0.3,1) forwards',
				'cipher-breathe':  'cipher-breathe 9s ease-in-out infinite'
			}
		}
	},
